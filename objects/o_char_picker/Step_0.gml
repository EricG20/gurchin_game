...
/// @DnDVersion : 1
/// @DnDHash : 5DD9B3BA
/// @DnDArgument : "expr" "lerp(scroll_pos, char_in_question, .2*global.game_speed)"
/// @DnDArgument : "var" "scroll_pos"
scroll_pos = lerp(scroll_pos, char_in_question, .2*global.game_speed);
	...
	var l09C19EE9_0 = state;switch(l09C19EE9_0){	/// @DnDAction : YoYo Games.Switch.Case
		...
		case select_state.CHARACTER:	/// @DnDAction : YoYo Games.Common.If_Expression
			...
			if(InputPressed(INPUT_VERB.CANCEL)){	/// @DnDAction : YoYo Games.Audio.Play_Audio
				...
				/// @DnDHash : 5F81BED8
				/// @DnDParent : 51624713
				/// @DnDArgument : "soundid" "uidecline"
				/// @DnDSaveInfo : "soundid" "uidecline"
				audio_play_sound(uidecline, 0, 0, 1.0, undefined, 1.0);
				...
				script_execute(scr_dynamic_song, "menu", 0);
			...
			if(InputPressed(INPUT_VERB.RIGHT)){	/// @DnDAction : YoYo Games.Common.Variable
				...
				/// @DnDHash : 09125839
				/// @DnDParent : 0761A331
				/// @DnDArgument : "soundid" "uimove2"
				/// @DnDSaveInfo : "soundid" "uimove2"
				audio_play_sound(uimove2, 0, 0, 1.0, undefined, 1.0);}
			...
			if(InputPressed(INPUT_VERB.JUMP)){	/// @DnDAction : YoYo Games.Data Structures.List_Get_At
				...
				/// @DnDHash : 3A70F685
				/// @DnDParent : 5E0DB7B3
				/// @DnDArgument : "soundid" "uiaccept"
				/// @DnDSaveInfo : "soundid" "uiaccept"
				audio_play_sound(uiaccept, 0, 0, 1.0, undefined, 1.0);
				...
				var l5CB8FA84_0 = picked_char;switch(l5CB8FA84_0){	/// @DnDAction : YoYo Games.Switch.Case
					...
					case "J0UL3S":	/// @DnDAction : YoYo Games.Data Structures.List_Add
						...
						/// @DnDParent : 7EDB558B
						/// @DnDArgument : "var" "hair_styles"
						/// @DnDArgument : "value" ""bald""
						ds_list_add(hair_styles, "bald");	break;}
		...
		case select_state.HAIR:	/// @DnDAction : YoYo Games.Data Structures.List_Count
			...
			if(InputPressed(INPUT_VERB.CANCEL)){	/// @DnDAction : YoYo Games.Common.Variable
				...
				/// @DnDArgument : "var" "state"
				/// @DnDArgument : "var_1" "hair_style_in_question"
				state = select_state.CHARACTER;
				hair_style_in_question = 0;
