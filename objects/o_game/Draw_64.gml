...
/// @DnDParent : 471424DB
/// @DnDArgument : "x" "20"
/// @DnDArgument : "y" "700 + 70*i"
/// @DnDArgument : "caption" "string(i) + ": ""
/// @DnDArgument : "text" "global.players[i]"
...
var l03FDEC77_0 = state;switch(l03FDEC77_0){	/// @DnDAction : YoYo Games.Switch.Case
	...
	case gm.PYLON:	/// @DnDAction : YoYo Games.Drawing.Draw_Value_Transformed
		...
		/// @DnDArgument : "x" "20"
		/// @DnDArgument : "y" "310"
		/// @DnDArgument : "xscale" "3.57142857143"
		/// @DnDArgument : "yscale" "2+infobox_height"
		/// @DnDArgument : "alpha" ".7"
		/// @DnDArgument : "sprite" "comb_background"
		/// @DnDSaveInfo : "sprite" "comb_background"
		draw_sprite_ext(comb_background, 0, 20, 310, 3.57142857143, 2+infobox_height, 0, $FFFFFF & $ffffff, .7);
		...
		/// @DnDArgument : "script" "draw_text_colour_outline"
		/// @DnDArgument : "arg" "125"
		/// @DnDArgument : "arg_1" "340"
		/// @DnDArgument : "arg_2" ""Score: " + string(round(display_score))"
		/// @DnDArgument : "arg_3" "c_white"
		/// @DnDArgument : "arg_4" "c_white"
		/// @DnDArgument : "arg_5" "1"
		...
		/// @DnDArgument : "arg_13" "0"
		/// @DnDSaveInfo : "script" "draw_text_colour_outline"
		script_execute(draw_text_colour_outline, 125, 340, "Score: " + string(round(display_score)), c_white, c_white, 1, c_white, c_white, .1, 2, 8, 1, 1, 0);
	
		/// @DnDAction : YoYo Games.Drawing.Draw_Sprite
		/// @DnDVersion : 1
		/// @DnDHash : 2CFC791B
		/// @DnDParent : 08A52609
		/// @DnDArgument : "x" "110 - string_width("FLUB: " + string(round(display_flub)))/2"
		/// @DnDArgument : "y" "380"
		/// @DnDArgument : "sprite" "s_flub"
		/// @DnDSaveInfo : "sprite" "s_flub"
		draw_sprite(s_flub, 0, 110 - string_width("FLUB: " + string(round(display_flub)))/2, 380);
	
		/// @DnDAction : YoYo Games.Drawing.Draw_Sprite_Transformed
		/// @DnDVersion : 1
		/// @DnDHash : 6BAC3ADB
		/// @DnDParent : 08A52609
		/// @DnDArgument : "x" "103 - string_width("FLUB: " + string(round(display_flub)))/2"
		/// @DnDArgument : "y" "380+5"
		/// @DnDArgument : "sprite" "s_flub"
		/// @DnDArgument : "col" "c_aqua"
		/// @DnDSaveInfo : "sprite" "s_flub"
		draw_sprite_ext(s_flub, 0, 103 - string_width("FLUB: " + string(round(display_flub)))/2, 380+5, 1, 1, 0, c_aqua & $ffffff, 1);
		...
		/// @DnDArgument : "script" "draw_text_colour_outline"
		/// @DnDArgument : "arg" "125"
		/// @DnDArgument : "arg_1" "380"
		/// @DnDArgument : "arg_2" ""FLUB: " + string(round(display_flub))"
		/// @DnDArgument : "arg_3" "c_aqua"
		/// @DnDArgument : "arg_4" "c_aqua"
		/// @DnDArgument : "arg_5" "1"
		/// @DnDArgument : "arg_6" "c_aqua"
		...
		/// @DnDArgument : "arg_13" "0"
		/// @DnDSaveInfo : "script" "draw_text_colour_outline"
		script_execute(draw_text_colour_outline, 125, 380, "FLUB: " + string(round(display_flub)), c_aqua, c_aqua, 1, c_aqua, c_aqua, .1, 2, 8, 1, 1, 0);
		...
		/// @DnDInput : 2
		/// @DnDParent : 08A52609
		/// @DnDArgument : "var" "combo_num_color"
		/// @DnDArgument : "value" "c_gray"
		/// @DnDArgument : "var_1" "extra_bangs"
		/// @DnDArgument : "value_1" """"
		var combo_num_color = c_gray;
		var extra_bangs = "";
		...
		if(in_wave){	/// @DnDAction : YoYo Games.Common.Variable
			...
			/// @DnDHash : 1EA319EB
			/// @DnDParent : 6161750C
			/// @DnDArgument : "expr" "lerp(infobox_height, 1.4, .2*global.game_speed)"
			/// @DnDArgument : "var" "infobox_height"
			infobox_height = lerp(infobox_height, 1.4, .2*global.game_speed);
		
			/// @DnDAction : YoYo Games.Common.If_Expression
			/// @DnDVersion : 1
			/// @DnDHash : 3D153FFD
			/// @DnDParent : 6161750C
			/// @DnDArgument : "expr" "combo_num >= 1 "
			if(combo_num >= 1 ){	/// @DnDAction : YoYo Games.Common.Temp_Variable
				/// @DnDVersion : 1
				/// @DnDHash : 31744F7E
				/// @DnDInput : 2
				/// @DnDParent : 3D153FFD
				/// @DnDArgument : "var" "combo_num_color"
				/// @DnDArgument : "value" "merge_colour(c_orangish, c_white, abs(sin(current_time/(3000*power((combo_bar/530), global.game_speed)) ) ) )"
				/// @DnDArgument : "var_1" "extra_bangs"
				/// @DnDArgument : "value_1" "string_repeat("!", floor(combo_num/15))"
				var combo_num_color = merge_colour(c_orangish, c_white, abs(sin(current_time/(3000*power((combo_bar/530), global.game_speed)) ) ) );
				var extra_bangs = string_repeat("!", floor(combo_num/15));
				...
				/// @DnDArgument : "x" "50"
				/// @DnDArgument : "y" "437"
				/// @DnDArgument : "xscale" "3.4*(combo_bar/530)"
				/// @DnDArgument : "yscale" ".5"
				/// @DnDArgument : "sprite" "spr_tinyhudbar"
				/// @DnDArgument : "col" "combo_num_color"
				/// @DnDSaveInfo : "sprite" "spr_tinyhudbar"
				draw_sprite_ext(spr_tinyhudbar, 0, 50, 437, 3.4*(combo_bar/530), .5, 0, combo_num_color & $ffffff, 1);}
			...
			/// @DnDArgument : "script" "draw_text_colour_outline"
			/// @DnDArgument : "arg" "125"
			/// @DnDArgument : "arg_1" "420"
			/// @DnDArgument : "arg_2" ""Combo: " + string(round(combo_num))+extra_bangs"
			/// @DnDArgument : "arg_3" "combo_num_color"
			/// @DnDArgument : "arg_4" "combo_num_color"
			/// @DnDArgument : "arg_5" "1"
			/// @DnDArgument : "arg_6" "combo_num_color"
			/// @DnDArgument : "arg_7" "combo_num_color"
			/// @DnDArgument : "arg_8" ".1"
			/// @DnDArgument : "arg_9" "2"
			/// @DnDArgument : "arg_10" "8"
			/// @DnDArgument : "arg_11" "1"
			...
			/// @DnDArgument : "arg_13" "0"
			/// @DnDSaveInfo : "script" "draw_text_colour_outline"
			script_execute(draw_text_colour_outline, 125, 420, "Combo: " + string(round(combo_num))+extra_bangs, combo_num_color, combo_num_color, 1, combo_num_color, combo_num_color, .1, 2, 8, 1, 1, 0);
			...
			/// @DnDArgument : "script" "draw_text_colour_outline"
			/// @DnDArgument : "arg" "125"
			/// @DnDArgument : "arg_1" "460"
			/// @DnDArgument : "arg_2" ""ENMY: " + string(pylon_enemy_goal-(pylon_enemies-pylon_enemy_count))"
			/// @DnDArgument : "arg_3" "$FFED00CD"
			/// @DnDArgument : "arg_4" "$FFED00CD"
			/// @DnDArgument : "arg_5" "1"
			/// @DnDArgument : "arg_6" "$FFED00CD"
			/// @DnDArgument : "arg_7" "$FFED00CD"
			/// @DnDArgument : "arg_8" ".1"
			/// @DnDArgument : "arg_9" "2"
			/// @DnDArgument : "arg_10" "8"
			/// @DnDArgument : "arg_11" "1"
			...
			/// @DnDArgument : "arg_13" "0"
			/// @DnDSaveInfo : "script" "draw_text_colour_outline"
			script_execute(draw_text_colour_outline, 125, 460, "ENMY: " + string(pylon_enemy_goal-(pylon_enemies-pylon_enemy_count)), $FFED00CD, $FFED00CD, 1, $FFED00CD, $FFED00CD, .1, 2, 8, 1, 1, 0);}
		...
		if(!(in_wave)){	/// @DnDAction : YoYo Games.Common.Variable
			...
			/// @DnDHash : 43D646BA
			/// @DnDParent : 6C959900
			/// @DnDArgument : "expr" "lerp(infobox_height, 0, .2*global.game_speed)"
			/// @DnDArgument : "var" "infobox_height"
			infobox_height = lerp(infobox_height, 0, .2*global.game_speed);}
		...
		if(!(in_wave)){	/// @DnDAction : YoYo Games.Drawing.Draw_Healthbar
			...
			if(can_skip_wave){	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				if(!(hosting)){	/// @DnDAction : YoYo Games.Drawing.Draw_Value
					...
					/// @DnDArgument : "x" "1750"
					/// @DnDArgument : "y" "680"
					/// @DnDArgument : "caption" ""Only the \nhost can \nskip.""
					draw_text(1750, 680, string("Only the \nhost can \nskip.") + "");}
				...
				if(skip_wave_value >= 120){	/// @DnDAction : YoYo Games.Common.Variable
					...
					var l36BFF6AC_0 = false;l36BFF6AC_0 = instance_exists(o_net_host);if(l36BFF6AC_0){	/// @DnDAction : YoYo Games.Common.Execute_Code
						/// @DnDVersion : 1
						/// @DnDHash : 67D47390
						/// @DnDParent : 36BFF6AC
						/// @DnDArgument : "code" "for (var i = 0; i < ds_list_size(o_net_host.socket_list); i++;){$(13_10)		send_game_packet(ds_list_find_value(o_net_host.socket_list, i));$(13_10)	}"
		...
		if(in_wave){	/// @DnDAction : YoYo Games.Drawing.Draw_Value_Transformed
			...
			/// @DnDArgument : "x" "50"
			/// @DnDArgument : "y" "390"
			/// @DnDArgument : "caption" ""VURMIN LEFT: ""
			/// @DnDArgument : "text" "pylon_enemy_goal-(pylon_enemies-pylon_enemy_count)"
			...
			/// @DnDArgument : "x2" "220"
			/// @DnDArgument : "y2" "435"
			/// @DnDArgument : "value" "((pylon_enemy_goal-(pylon_enemies-pylon_enemy_count))/pylon_enemy_goal)*100"
			/// @DnDArgument : "backcol" "$FF000000"
	...
	case gm.RESULTS:	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "script" "draw_text_colour_outline"
		/// @DnDArgument : "arg" "960"
		/// @DnDArgument : "arg_1" "540"
		/// @DnDArgument : "arg_2" ""FINAL SCORE\n ________________ \n" + string(round(display_score))"
		/// @DnDArgument : "arg_3" "c_white"
		/// @DnDArgument : "arg_4" "c_white"
		/// @DnDArgument : "arg_5" "1"
		/// @DnDArgument : "arg_6" "c_black"
		...
		/// @DnDArgument : "arg_13" "0"
		/// @DnDSaveInfo : "script" "draw_text_colour_outline"
		script_execute(draw_text_colour_outline, 960, 540, "FINAL SCORE\n ________________ \n" + string(round(display_score)), c_white, c_white, 1, c_black, c_black, 1, 2, 8, 3, 3, 0);
		...
		if(!(display_score == scor)){	/// @DnDAction : YoYo Games.Drawing.Draw_Value_Transformed
			...
			/// @DnDArgument : "x" "960"
			/// @DnDArgument : "y" "700"
			/// @DnDArgument : "caption" ""Press -SPACE- to skip the wait""
			draw_text_transformed(960, 700, string("Press -SPACE- to skip the wait") + "", 1, 1, 0);
		...
		if(display_score == scor){	/// @DnDAction : YoYo Games.Common.If_Expression
			...
			/// @DnDParent : 70E16DA4
				...
				var l071223A4_0;l071223A4_0 = keyboard_check_pressed(vk_space);if (l071223A4_0){	/// @DnDAction : YoYo Games.Common.Variable
					...
					/// @DnDArgument : "x" "960"
					/// @DnDArgument : "y" "700"
					/// @DnDArgument : "caption" ""Press -SPACE- to go back to the Main Menu""
					draw_text_transformed(960, 700, string("Press -SPACE- to go back to the Main Menu") + "", 1, 1, 0);
