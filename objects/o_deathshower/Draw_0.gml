...
switch(l29A2478F_0)
{
	...
	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "sprite" "s_deathshower"
		/// @DnDArgument : "frame" "image_index"
		/// @DnDSaveInfo : "sprite" "s_deathshower"
		draw_sprite_ext(s_deathshower, image_index, weilder.x+(kickbackx+shakex), weilder.y+(shakey+kickbacky)-41+(weilder.head_offset_y)/2, 1, weilder.facing, image_angle + androtate*weilder.facing, $FFFFFF & $ffffff, 1);
	break;
	...
	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "frame" "image_index"
		/// @DnDSaveInfo : "sprite" "s_deathshower"
		draw_sprite_ext(s_deathshower, image_index, x + weilder.facing*kickbackx+shakex, y + shakey+kickbacky, 1, weilder.facing, image_angle + androtate*weilder.facing, $FFFFFF & $ffffff, 1);
	break;
	...
	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "sprite" "s_deathshower"
		/// @DnDSaveInfo : "sprite" "s_deathshower"
		draw_sprite_ext(s_deathshower, 0, x + weilder.facing*kickbackx+shakex, y + shakey+kickbacky, 1, weilder.facing, image_angle + androtate*weilder.facing, $FFFFFF & $ffffff, 1);
