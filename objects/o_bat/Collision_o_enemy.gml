	...
	case stance.SHOT:	/// @DnDAction : YoYo Games.Common.If_Expression
		...
		if(image_index >= 3 && image_index <= 5){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			if(ds_list_find_index(collided_with,other.id) == -1){	/// @DnDAction : YoYo Games.Instances.Set_Alarm
				...
				/// @DnDHash : 36AEAE8A
				/// @DnDParent : 46DEE259
				/// @DnDArgument : "expr" "5+2*(image_xscale)"
				/// @DnDArgument : "var" "stun_amount"
				stun_amount = 5+2*(image_xscale);
				...
				kb_hsp = lengthdir_x(10*(image_xscale),image_angle);
				kb_vsp = lengthdir_y(10*(image_xscale),image_angle);
				...
				/// @DnDArgument : "op" "4"
				/// @DnDArgument : "value" "1.81+o_player.curr_weapon_level*.3"
				if(image_xscale >= 1.81+o_player.curr_weapon_level*.3){	/// @DnDAction : YoYo Games.Audio.Play_Audio
					/// @DnDVersion : 1.1
					/// @DnDHash : 2D3FD385
					/// @DnDParent : 792DB668
