...
function movement_stuff() {	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(global.we_can_move == true){	/// @DnDAction : YoYo Games.Switch.Switch
		...
		var l13B4DA78_0 = object_index;switch(l13B4DA78_0){	/// @DnDAction : YoYo Games.Switch.Case
			...
			/// @DnDHash : 340B5DAC
			/// @DnDParent : 13B4DA78
			/// @DnDArgument : "const" "e_enemy_walkah_shit"
			case e_enemy_walkah_shit:	/// @DnDAction : YoYo Games.Common.If_Expression
				/// @DnDVersion : 1
				/// @DnDHash : 131F48BC
				/// @DnDParent : 340B5DAC
				/// @DnDArgument : "expr" "on_ground"
			...
			/// @DnDHash : 72C8157D
			/// @DnDParent : 13B4DA78
			/// @DnDArgument : "const" "o_enemy_runna"
			case o_enemy_runna:	/// @DnDAction : YoYo Games.Common.If_Expression
				/// @DnDVersion : 1
				/// @DnDHash : 5F1B9147
				/// @DnDParent : 72C8157D
			...
			/// @DnDHash : 7D7D27C0
			/// @DnDParent : 13B4DA78
			/// @DnDArgument : "const" "o_fat_enemy_walkah"
			case o_fat_enemy_walkah:	/// @DnDAction : YoYo Games.Common.If_Expression
				/// @DnDVersion : 1
				/// @DnDHash : 48AFC81D
				/// @DnDParent : 7D7D27C0
				/// @DnDArgument : "expr" "on_ground"
		...
		var l2CF77335_0 = object_index;switch(l2CF77335_0){	/// @DnDAction : YoYo Games.Switch.Default
			...
			case o_player:	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				if(sliding){	/// @DnDAction : YoYo Games.Common.Variable
					...
					/// @DnDHash : 6C8230F3
					/// @DnDParent : 75381642
					/// @DnDArgument : "var" "slide_increase"
					/// @DnDArgument : "value" "y-yprevious"
					var slide_increase = y-yprevious;
				
					/// @DnDAction : YoYo Games.Common.Temp_Variable
					/// @DnDVersion : 1
					/// @DnDHash : 7BDE2578
					/// @DnDParent : 75381642
					/// @DnDArgument : "var" "slide_dir"
					/// @DnDArgument : "value" "sign(x-xprevious)"
					var slide_dir = sign(x-xprevious);
				...
				/// @DnDArgument : "object" "o_solid"
				/// @DnDSaveInfo : "object" "o_solid"
				var l6A9362B9_0 = instance_place(x + 0, y + vsp*global.game_speed, [o_solid]);if ((l6A9362B9_0 > 0)){	/// @DnDAction : YoYo Games.Common.Temp_Variable
					/// @DnDVersion : 1
					/// @DnDHash : 463435DB
					/// @DnDParent : 6A9362B9
					/// @DnDArgument : "var" "collide"
					...
					while ((collide == false)) {
						...
						/// @DnDArgument : "not" "1"
						/// @DnDSaveInfo : "object" "o_solid"
						var l5E97189E_0 = instance_place(x + 0, y + sign(vsp)*global.game_speed, [o_solid]);if (!(l5E97189E_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
							/// @DnDVersion : 1
							/// @DnDHash : 5E6379B8
							/// @DnDParent : 5E97189E
							/// @DnDArgument : "expr" "sign(vsp)*global.game_speed"
		...
		var l7E423C0F_0 = object_index;switch(l7E423C0F_0){	/// @DnDAction : YoYo Games.Switch.Default
			...
			case o_player:	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				if(!(boostydir >= .55)){	/// @DnDAction : YoYo Games.Collisions.If_Object_At
					...
					/// @DnDArgument : "object" "o_onewayplats"
					/// @DnDSaveInfo : "object" "o_onewayplats"
					var l6F182DAB_0 = instance_place(x + 0, y + vsp*global.game_speed, [o_onewayplats]);
					blarg = l6F182DAB_0;if ((l6F182DAB_0 > 0)){	/// @DnDAction : YoYo Games.Common.If_Variable
						/// @DnDVersion : 1
						/// @DnDHash : 7B34464A
						/// @DnDParent : 6F182DAB
						...
						if(bbox_bottom < blarg.bbox_top+2){	/// @DnDAction : YoYo Games.Common.If_Variable
							...
							if(vsp*global.game_speed > 0){	/// @DnDAction : YoYo Games.Common.Temp_Variable
								...
								while ((collide == false)) {
									...
									/// @DnDArgument : "not" "1"
									/// @DnDSaveInfo : "object" "o_onewayplats"
									var l5FEA3495_0 = instance_place(x + 0, y + sign(vsp)*global.game_speed, [o_onewayplats]);if (!(l5FEA3495_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
										/// @DnDVersion : 1
										/// @DnDHash : 223E3605
										/// @DnDParent : 5FEA3495
										/// @DnDArgument : "expr" "sign(vsp)*global.game_speed"
			...
			case o_boss_gurchenis:	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				/// @DnDHash : 406D21C0
				/// @DnDParent : 2423213D
				/// @DnDArgument : "expr" "(state != GURCHENIS.CRASH || destination_y-5<=y)"
				if((state != GURCHENIS.CRASH || destination_y-5<=y)){	/// @DnDAction : YoYo Games.Collisions.If_Object_At
					/// @DnDVersion : 1.1
					/// @DnDHash : 0ED5A99D
					/// @DnDParent : 406D21C0
					/// @DnDArgument : "x_relative" "1"
					...
					/// @DnDArgument : "object" "o_onewayplats"
					/// @DnDSaveInfo : "object" "o_onewayplats"
					var l0ED5A99D_0 = instance_place(x + 0, y + vsp*global.game_speed, [o_onewayplats]);
					blarg = l0ED5A99D_0;if ((l0ED5A99D_0 > 0)){	/// @DnDAction : YoYo Games.Common.If_Variable
						/// @DnDVersion : 1
						/// @DnDHash : 72AA2B75
						/// @DnDParent : 0ED5A99D
						...
						if(bbox_bottom < blarg.bbox_top+2){	/// @DnDAction : YoYo Games.Common.If_Variable
							...
							if(vsp*global.game_speed > 0){	/// @DnDAction : YoYo Games.Common.Temp_Variable
								...
								while ((collide == false)) {
									...
									/// @DnDArgument : "not" "1"
									/// @DnDSaveInfo : "object" "o_onewayplats"
									var l4CC27299_0 = instance_place(x + 0, y + sign(vsp)*global.game_speed, [o_onewayplats]);if (!(l4CC27299_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
										/// @DnDVersion : 1
										/// @DnDHash : 256BD464
										/// @DnDParent : 4CC27299
										/// @DnDArgument : "expr" "sign(vsp)*global.game_speed"
		...
		/// @DnDDisabled : 1
		/// @DnDParent : 72E42ED5
		/// @DnDArgument : "expr" "global.we_can_move"
		/// @DnDAction : YoYo Games.Common.Variable
		/// @DnDVersion : 1
		/// @DnDHash : 12C40019
		/// @DnDParent : 4D3ADBA2
