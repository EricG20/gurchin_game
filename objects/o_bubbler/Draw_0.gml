...
var l29A2478F_0 = anim;switch(l29A2478F_0){	/// @DnDAction : YoYo Games.Switch.Case
	...
	case stance.CASUAL:	/// @DnDAction : YoYo Games.Common.Variable
		...
		draw_sprite_ext(armed_sprite, image_index, o_player.x+(kickbackx+shakex), o_player.y+(shakey+kickbacky)-41+(o_player.head_offset_y)/2, 1, o_player.facing, image_angle + androtate*o_player.facing, $FFFFFF & $ffffff, 1);	break;
	...
	case stance.SHOT:	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "sprite" "armed_sprite"
		/// @DnDArgument : "frame" "image_index"
		draw_sprite_ext(armed_sprite, image_index, x + o_player.facing*kickbackx+shakex, y + shakey+kickbacky, 1, o_player.facing, image_angle + androtate*o_player.facing, $FFFFFF & $ffffff, 1);	break;
	...
	case stance.GUARDING:	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "rot_relative" "1"
		/// @DnDArgument : "sprite" "armed_sprite"
		draw_sprite_ext(armed_sprite, 0, x + o_player.facing*kickbackx+shakex, y + shakey+kickbacky, 1, o_player.facing, image_angle + androtate*o_player.facing, $FFFFFF & $ffffff, 1);
	...
	case stance.RELOAD:	/// @DnDAction : YoYo Games.Common.Variable
		...
		/// @DnDArgument : "arg_6" "200/global.reload_bonus"
		/// @DnDArgument : "arg_7" "1"
		/// @DnDArgument : "arg_8" "90"
		/// @DnDArgument : "arg_9" "false"
		/// @DnDArgument : "arg_10" "1"
		/// @DnDSaveInfo : "script" "draw_wheel_ext"
		script_execute(draw_wheel_ext, o_cursor.x, o_cursor.y, 40, 30, c_lime, charge, 200/global.reload_bonus, 1, 90, false, 1);	break;}