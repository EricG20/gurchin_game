...
function controlz() {	/// @DnDAction : YoYo Games.Switch.Switch
	...
	/// @DnDHash : 44D346F1
	/// @DnDParent : 222DF977
	/// @DnDArgument : "expr" "control_type"
	var l44D346F1_0 = control_type;switch(l44D346F1_0){	/// @DnDAction : YoYo Games.Switch.Case
		/// @DnDVersion : 1
		/// @DnDHash : 22FACA17
		/// @DnDParent : 44D346F1
		/// @DnDArgument : "const" "cr.LOCAL"
		case cr.LOCAL:	/// @DnDAction : YoYo Games.Common.Variable
			...
			if(global.we_can_move == true){	/// @DnDAction : YoYo Games.Common.Variable
				...
				/// @DnDArgument : "expr_6" "InputPressed(INPUT_VERB.CANCEL)"
				...
				cancel = InputPressed(INPUT_VERB.CANCEL);
				...
				if(true){	/// @DnDAction : YoYo Games.Common.Execute_Code
					...
					for (var i = 0; i < array_length(keys); i++) {
					    ...
					    inputs[$ key] = variable_instance_get(id, key);
					}
		...
		case cr.NET:	/// @DnDAction : YoYo Games.Common.Variable
			...
			/// @DnDArgument : "expr_6" "false"
			/// @DnDArgument : "var" "jump_release"
			/// @DnDArgument : "var_1" "shoot_release"
			/// @DnDArgument : "var_2" "swap"
			/// @DnDArgument : "var_3" "accept"
