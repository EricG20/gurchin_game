...
var l29A2478F_0 = anim;switch(l29A2478F_0){	/// @DnDAction : YoYo Games.Switch.Case
	...
	case stance.CASUAL:	/// @DnDAction : YoYo Games.Common.Variable
		...
		draw_sprite_ext(s_player_arms, image_index, o_player.x+(kickbackx+shakex), o_player.y+(shakey+kickbacky)-41+(o_player.head_offset_y)/2, 1, o_player.facing, image_angle + androtate*o_player.facing, $FFFFFF & $ffffff, 1);	break;
	...
	case stance.RELOAD:	/// @DnDAction : YoYo Games.Common.Variable
		...
		draw_healthbar(mouse_x-19, mouse_y-50, mouse_x-2, mouse_y+50, 100-(charge/120 * 100), $BD000000 & $FFFFFF, $FFFF0000 & $FFFFFF, $FF00FF00 & $FFFFFF, 3, (($BD000000>>24) != 0), (($00000000>>24) != 0));	break;}