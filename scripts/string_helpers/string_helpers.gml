...
function wrap_text(_str, _limit, spacing = 1) {
    ...
    while (string_length(text) > _limit) {
        ...
        result += string_copy(text, 1, pos) + string_repeat("\n", spacing);
