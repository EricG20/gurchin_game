...
if (type == network_type_data) {
	...
	if(packet_type == 0){
		...
		show_debug_message("Punch packet from: " + _ip);
		
		global.client_public_ip = _ip;
		global.client_public_port = _port;
