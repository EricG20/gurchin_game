...
function flash_operate() 
{
	...
	draw_sprite_ext(sprite_index, image_index, x + 0, y + 0, facing, image_yscale, 0, $00FFFFFF & $ffffff, 1);
	...
	if(flashAlpha > 0)
	{
		...
		draw_sprite_ext(sprite_index, image_index, x + 0, y + 0, facing, image_yscale, 0, flashColor & $ffffff, flashAlpha);
