...
if(on_ground && state != es.KNOCKBACK){	/// @DnDAction : YoYo Games.Common.Variable
	...
	/// @DnDInput : 2
	/// @DnDParent : 2A5A8999
	/// @DnDArgument : "expr" "facing*(2+variance)*(.1 * global.game_speed)"
	/// @DnDArgument : "expr_relative" "1"
	/// @DnDArgument : "expr_1" "clamp(hsp, -(2+variance), 2+variance)"
	/// @DnDArgument : "var" "hsp"
	/// @DnDArgument : "var_1" "hsp"
	hsp += facing*(2+variance)*(.1 * global.game_speed);
	hsp = clamp(hsp, -(2+variance), 2+variance);}
