...
if(!(global.game_speed == 0)){	/// @DnDAction : YoYo Games.Common.Variable
	...
	/// @DnDHash : 31079929
	/// @DnDParent : 5B389BFB
	/// @DnDArgument : "expr" "36*weilder.curr_weapon_level"
	/// @DnDArgument : "var" "ammo_cap"
	ammo_cap = 36*weilder.curr_weapon_level;
	...
	if(!(anim == stance.RELOAD)){	/// @DnDAction : YoYo Games.Common.If_Expression
		...
		if(weilder.shooting){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Mouse_Down
			...
			/// @DnDArgument : "var" "charge"
			/// @DnDArgument : "op" "4"
			/// @DnDArgument : "value" "(7-weilder.curr_weapon_level)/clamp((global.firerate_bonus*weilder.firerate_bonus)*.72,1,2)"
			if(charge >= (7-weilder.curr_weapon_level)/clamp((global.firerate_bonus*weilder.firerate_bonus)*.72,1,2)){	/// @DnDAction : YoYo Games.Audio.Play_Audio
				/// @DnDVersion : 1.1
				/// @DnDHash : 30B085F3
				/// @DnDParent : 3A9CC710
				...
				audio_play_sound(sfx_shoot, 0, 0, .7, undefined, random_range(.8,1.2)+.4);
				...
				/// @DnDParent : 3A9CC710
					...
					/// @DnDArgument : "value" "point_direction(x,y,weilder.reticle.x,weilder.reticle.y)+random_range(-6,6)"
					var bulletrotation = point_direction(x,y,weilder.reticle.x,weilder.reticle.y)+random_range(-6,6);
					...
					/// @DnDArgument : "arg_2" "65+random_range(-3,3)"
					/// @DnDArgument : "arg_3" "s_ironbullet"
					/// @DnDArgument : "arg_4" ".4"
					/// @DnDSaveInfo : "script" "scr_adjust_projectile_params"
					script_execute(scr_adjust_projectile_params, mybb, bulletrotation, 65+random_range(-3,3), s_ironbullet, .4);
