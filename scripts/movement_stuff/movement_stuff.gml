...
function movement_stuff() {	/// @DnDAction : YoYo Games.Switch.Switch
	...
	/// @DnDHash : 5BE86870
	/// @DnDParent : 430C202A
	/// @DnDArgument : "code" "if place_meeting(x+hsp,y,o_solid)$(13_10){$(13_10)    yplus = 0;$(13_10)    while (place_meeting(x+hsp,y-yplus,o_solid) && yplus <= abs(1*hsp)) yplus += 1;$(13_10)    if place_meeting(x+hsp,y-yplus,o_solid)$(13_10)    {$(13_10)        while (!place_meeting(x+sign(hsp),y,o_solid)) x+=sign(hsp);$(13_10)        hsp = 0;$(13_10)    }$(13_10)    else$(13_10)    {$(13_10)        y -= yplus$(13_10)    }$(13_10)}$(13_10)x += hsp;$(13_10)$(13_10)// Downward slopes$(13_10)if !place_meeting(x,y,o_solid) && vsp >= 0 && place_meeting(x,y+2+abs(hsp),o_solid)$(13_10){while(!place_meeting(x,y+1,o_solid)) {y += 1;}}$(13_10)$(13_10)$(13_10)$(13_10)$(13_10)    //Vertical Collision and Gravity$(13_10)    if (!on_ground)$(13_10)    {$(13_10)        //vsp += global.grav;$(13_10)    }$(13_10)$(13_10)    //Vertical Collision$(13_10)    if (place_meeting(x, y+vsp, o_solid))$(13_10)    {$(13_10)   $(13_10)        //vsp = 0;$(13_10)   $(13_10)    }$(13_10)$(13_10)$(13_10)"
	if place_meeting(x+hsp,y,o_solid)
	{
	    yplus = 0;
	    while (place_meeting(x+hsp,y-yplus,o_solid) && yplus <= abs(1*hsp)) yplus += 1;
	    if place_meeting(x+hsp,y-yplus,o_solid)
	    {
	...
	// Downward slopes
	if !place_meeting(x,y,o_solid) && vsp >= 0 && place_meeting(x,y+2+abs(hsp),o_solid)
	...
	var l2A1BF79D_0 = instance_place(x + 0, y + vsp, [o_solid]);if ((l2A1BF79D_0 > 0)){	/// @DnDAction : YoYo Games.Common.Temp_Variable
		/// @DnDVersion : 1
		/// @DnDHash : 5D15CBDB
		/// @DnDParent : 2A1BF79D
		...
		while ((collide == false)) {
			...
			/// @DnDArgument : "not" "1"
			/// @DnDSaveInfo : "object" "o_solid"
			var l65C1B8BF_0 = instance_place(x + 0, y + sign(vsp), [o_solid]);if (!(l65C1B8BF_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
				/// @DnDVersion : 1
				/// @DnDHash : 7E4A546D
				/// @DnDParent : 65C1B8BF
	...
	var l7E423C0F_0 = object_index;switch(l7E423C0F_0){	/// @DnDAction : YoYo Games.Switch.Default
		...
		default:	/// @DnDAction : YoYo Games.Collisions.If_Object_At
			...
			var l62922723_0 = instance_place(x + 0, y + vsp, [o_onewayplats]);
				...
				if(bbox_bottom < blarg.bbox_top+2){	/// @DnDAction : YoYo Games.Common.If_Variable
					...
					if(vsp > 0){	/// @DnDAction : YoYo Games.Common.Temp_Variable
						...
						while ((collide == false)) {
							...
							/// @DnDArgument : "not" "1"
							/// @DnDSaveInfo : "object" "o_onewayplats"
							var l1F54D9E3_0 = instance_place(x + 0, y + sign(vsp), [o_onewayplats]);if (!(l1F54D9E3_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
								/// @DnDVersion : 1
								/// @DnDHash : 2BDC012A
								/// @DnDParent : 1F54D9E3
								/// @DnDArgument : "expr" "sign(vsp)"
