...
if(!(global.game_speed == 0)){	/// @DnDAction : YoYo Games.Common.Variable
	...
	/// @DnDArgument : "expr_7" "40*weilder.curr_weapon_level"
	/// @DnDArgument : "var" "x"
	/// @DnDArgument : "var_1" "y"
	...
	ammo_cap = 40*weilder.curr_weapon_level;
	...
	/// @DnDHash : 20AF416A
	/// @DnDParent : 5B389BFB
	/// @DnDArgument : "expr" "InputCheck(INPUT_VERB.SHOOT)"
	/// @DnDArgument : "not" "1"
	if(!(InputCheck(INPUT_VERB.SHOOT))){	/// @DnDAction : YoYo Games.Common.Variable
		/// @DnDVersion : 1
		/// @DnDHash : 1DFD65EA
		/// @DnDParent : 20AF416A
		/// @DnDArgument : "expr" "heat*.9"
	...
	if(!(anim == stance.RELOAD)){	/// @DnDAction : YoYo Games.Common.If_Expression
		...
		if(weilder.shooting){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Mouse_Down
			...
			/// @DnDInput : 2
			/// @DnDParent : 3F4C6B2D
			/// @DnDArgument : "expr" "1*global.game_speed+heat"
			/// @DnDArgument : "expr_relative" "1"
			/// @DnDArgument : "expr_1" "(.002*weilder.curr_weapon_level)*global.game_speed"
			/// @DnDArgument : "expr_relative_1" "1"
			/// @DnDArgument : "var" "charge"
			/// @DnDArgument : "var_1" "heat"
			charge += 1*global.game_speed+heat;
			heat += (.002*weilder.curr_weapon_level)*global.game_speed;
			...
			if(charge >= 18/global.firerate_bonus*weilder.firerate_bonus){	/// @DnDAction : YoYo Games.Audio.Play_Audio
				...
				/// @DnDHash : 30B085F3
				/// @DnDParent : 3A9CC710
				/// @DnDArgument : "soundid" "sfx_machinegun"
				/// @DnDArgument : "pitch" "random_range(.8,1.2)+heat*.5"
				/// @DnDSaveInfo : "soundid" "sfx_machinegun"
				audio_play_sound(sfx_machinegun, 0, 0, 1.0, undefined, random_range(.8,1.2)+heat*.5);
				...
				/// @DnDArgument : "arg" "random_range(-4,4)"
				/// @DnDArgument : "arg_1" "2"
				/// @DnDSaveInfo : "script" "scr_screenshake"
				script_execute(scr_screenshake, random_range(-4,4), 2);
				...
				if(weilder.curr_weapon_level >= 2){	/// @DnDAction : YoYo Games.Audio.Play_Audio
					...
					audio_play_sound(sfx_shotgun, 0, 0, .4, undefined, random_range(.9,1.1));
					...
					/// @DnDParent : 385EC84F
						...
						/// @DnDArgument : "arg_2" "41+random_range(-3,3)"
						/// @DnDArgument : "arg_3" "s_ironbullet"
						/// @DnDSaveInfo : "script" "scr_adjust_projectile_params"
						script_execute(scr_adjust_projectile_params, mybb, bulletrotation, 41+random_range(-3,3), s_ironbullet);
				...
				if(ammo <= 0){	/// @DnDAction : YoYo Games.Common.Variable
					...
					/// @DnDArgument : "expr_1" "(200+10*heat)/global.reload_bonus*weilder.reload_bonus"
					/// @DnDArgument : "var" "anim"
					/// @DnDArgument : "var_1" "charge"
					anim = stance.RELOAD;
					charge = (200+10*heat)/global.reload_bonus*weilder.reload_bonus;
		...
		if(weilder.reload){	/// @DnDAction : YoYo Games.Common.Variable
			...
			/// @DnDParent : 41F5BBEE
			/// @DnDArgument : "expr" "stance.RELOAD"
			/// @DnDArgument : "expr_1" "(200+70*heat)/global.reload_bonus*weilder.reload_bonus"
			/// @DnDArgument : "var" "anim"
			/// @DnDArgument : "var_1" "charge"
			anim = stance.RELOAD;
			charge = (200+70*heat)/global.reload_bonus*weilder.reload_bonus;
