...
draw_sprite_ext(sprite_index, image_index, x + 0, y + sin(current_time*(.003))*6, 1, 1, 0, $FFFFFFFF & $ffffff, 1);
	...
	case ps.IDLE:	/// @DnDAction : YoYo Games.Common.If_Variable
		...
		if(operate == true){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			if(cooldown == 0){	/// @DnDAction : YoYo Games.Common.Execute_Script
				...
				/// @DnDArgument : "arg" ""Provide flub to your Glorbulous Empress for a boon? (REQUIRES 900 FLUB)""
				/// @DnDSaveInfo : "script" "msg_static"
				script_execute(msg_static, "Provide flub to your Glorbulous Empress for a boon? (REQUIRES 900 FLUB)");}
			...
			/// @DnDParent : 37E68593
				...
				/// @DnDParent : 01D05A2E
				/// @DnDArgument : "script" "msg_static"
				/// @DnDArgument : "arg" ""The Empress needs " + string(cooldown/60*global.game_speed) + " more seconds before providing another boon.""
				/// @DnDSaveInfo : "script" "msg_static"
				script_execute(msg_static, "The Empress needs " + string(cooldown/60*global.game_speed) + " more seconds before providing another boon.");}}	break;
