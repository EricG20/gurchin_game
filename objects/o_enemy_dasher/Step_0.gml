...
var l5F73EA2D_0 = state;switch(l5F73EA2D_0){	/// @DnDAction : YoYo Games.Switch.Default
	...
	case es.ATTACK:	/// @DnDAction : YoYo Games.Common.Variable
		...
		if(charge_hold > 0){	/// @DnDAction : YoYo Games.Common.Variable
			...
			/// @DnDHash : 7E28B89B
			/// @DnDParent : 5A83F422
			/// @DnDArgument : "var" "floor(charge_hold) mod 6"
			if(floor(charge_hold) mod 6 == 0){	/// @DnDAction : YoYo Games.Instances.Create_Instance
				/// @DnDVersion : 1
				/// @DnDHash : 20722E3B
				/// @DnDParent : 7E28B89B
				...
				/// @DnDArgument : "expr_1" "floor(charge_hold)-1"
				/// @DnDArgument : "var" "doost.facing"
				/// @DnDArgument : "var_1" "charge_hold"
				doost.facing = facing;
				charge_hold = floor(charge_hold)-1;}}
