...
/// @DnDArgument : "yscale" "damage"
/// @DnDArgument : "rot" "point_direction(x-hsp,y-vsp,x,y)"
/// @DnDArgument : "sprite" "sprite_index"
/// @DnDArgument : "frame" "image_index"
/// @DnDArgument : "col" "bullet_color"
draw_sprite_ext(sprite_index, image_index, x + 0, y + 0, image_xscale + sqrt( sqr(hsp) + sqr(vsp) )/10, damage, point_direction(x-hsp,y-vsp,x,y), bullet_color & $ffffff, 1);