	...
	if(!(anim == stance.RELOAD)){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Mouse_Pressed
		...
		var l5D1B489A_0;l5D1B489A_0 = mouse_check_button_pressed(mb_left);if (l5D1B489A_0){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			if(charge <= 0){	/// @DnDAction : YoYo Games.Common.If_Variable
				...
				/// @DnDHash : 55E08394
				/// @DnDParent : 3A9CC710
				/// @DnDArgument : "var" "o_player.gon_level"
				/// @DnDArgument : "op" "1"
				/// @DnDArgument : "value" "5"
				if(o_player.gon_level < 5){	/// @DnDAction : YoYo Games.Audio.Play_Audio
					/// @DnDVersion : 1.1
					/// @DnDHash : 7F17A182
					/// @DnDParent : 55E08394
					...
					/// @DnDHash : 05D3A6F9
					/// @DnDParent : 55E08394
					/// @DnDArgument : "times" "o_player.gon_level"
					repeat(o_player.gon_level){	/// @DnDAction : YoYo Games.Instances.Create_Instance
						/// @DnDVersion : 1
						/// @DnDHash : 0BCEFDD0
						/// @DnDParent : 05D3A6F9
				...
				if(o_player.gon_level >= 5){	/// @DnDAction : YoYo Games.Instances.Create_Instance
					...
					mybb = instance_create_layer(x + 8*o_player.facing+glorp_x, y + -10+glorp_y, "Instances", o_big_bullet);
