...
var l139575C2_0 = instance_place(x + 0, y + 0, [o_cursor]);if ((l139575C2_0 > 0)){	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	if(data_mode == "bright_flashes"){	/// @DnDAction : YoYo Games.Common.Execute_Script
		...
		/// @DnDParent : 371AF139
		/// @DnDArgument : "script" "msg_static"
		/// @DnDArgument : "arg" ""When enabled, picking up a weapon will store the weapon you are holding in your inventory and remove the one furthest back in your inventory.""
		/// @DnDSaveInfo : "script" "msg_static"
		script_execute(msg_static, "When enabled, picking up a weapon will store the weapon you are holding in your inventory and remove the one furthest back in your inventory.");}}