...
function player_controlz() {	/// @DnDAction : YoYo Games.Common.Execute_Script
	...
	if(!(tick)){	/// @DnDAction : YoYo Games.Common.Temp_Variable
		...
		/// @DnDHash : 5957ACE1
		/// @DnDParent : 5EC131F0
		/// @DnDArgument : "var" "walkspeed_cap"
		/// @DnDArgument : "value" "walk_speed*global.movementspeed_bonus*movementspeed_bonus"
		var walkspeed_cap = walk_speed*global.movementspeed_bonus*movementspeed_bonus;
		...
		if(left){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			/// @DnDArgument : "var" "hsp"
			/// @DnDArgument : "op" "4"
			/// @DnDArgument : "value" "-walkspeed_cap"
			if(hsp >= -walkspeed_cap){	/// @DnDAction : YoYo Games.Common.If_Expression
				/// @DnDVersion : 1
				/// @DnDHash : 6EE044D8
				/// @DnDParent : 254172C9
			...
			if(on_ground == true){	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				if(!(down)){	/// @DnDAction : YoYo Games.Common.If_Expression
					...
					if(!(sliding)){	/// @DnDAction : YoYo Games.Common.Variable
						...
						/// @DnDHash : 4F0F7359
						/// @DnDParent : 7CFA9A32
						/// @DnDArgument : "expr" "clamp(hsp,left*-walkspeed_cap, walkspeed_cap)"
						/// @DnDArgument : "var" "hsp"
						hsp = clamp(hsp,left*-walkspeed_cap, walkspeed_cap);}}}
			...
			if(on_ground == true){	/// @DnDAction : YoYo Games.Common.If_Expression
				...
				if(!(down)){	/// @DnDAction : YoYo Games.Common.If_Expression
					...
					if(!(sliding)){	/// @DnDAction : YoYo Games.Common.Variable
						...
						/// @DnDHash : 5C6DB643
						/// @DnDParent : 58AC30B5
						/// @DnDArgument : "expr" "clamp(hsp,-walkspeed_cap, right*walkspeed_cap)"
						/// @DnDArgument : "var" "hsp"
						hsp = clamp(hsp,-walkspeed_cap, right*walkspeed_cap);}}}
	...
	if(mount == undefined){	/// @DnDAction : YoYo Games.Common.If_Expression
		...
		if(melee){	/// @DnDAction : YoYo Games.Common.Execute_Script
			...
			/// @DnDHash : 65D9991D
			/// @DnDParent : 0688F5D5
			/// @DnDArgument : "script" "scr_melee_handler"
			/// @DnDSaveInfo : "script" "scr_melee_handler"
			script_execute(scr_melee_handler);}}
	...
	if(special){	/// @DnDAction : YoYo Games.Common.Variable
		...
		if(special_meter >= special_meter_cap){	/// @DnDAction : YoYo Games.Audio.Play_Audio
			...
			/// @DnDArgument : "var" "special_meter"
			/// @DnDArgument : "var_1" "special_line_flag"
			special_meter = 0;
			special_line_flag = false;
