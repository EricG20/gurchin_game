...
function scr_laser(x_offset=0, y_offset=0, h_offset=10, collision_target=o_enemy, target_x=o_cursor.x, target_y=o_cursor.y, color_one=c_orange, color_two=c_yellow, color_three=c_white) {	/// @DnDAction : YoYo Games.Common.Execute_Code
	/// @DnDVersion : 1
	/// @DnDHash : 55B0531F
	/// @DnDParent : 467D13D6
