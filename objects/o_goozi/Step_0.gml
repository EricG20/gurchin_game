		...
		if(weilder.shooting){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Mouse_Down
			...
			if(charge >= (7-weilder.curr_weapon_level)/clamp((global.firerate_bonus)*.65,1,2)){	/// @DnDAction : YoYo Games.Audio.Play_Audio
				...
				/// @DnDParent : 3A9CC710
					...
					/// @DnDArgument : "value" "point_direction(x,y,o_cursor.x,o_cursor.y)+random_range(-6,6)"
					var bulletrotation = point_direction(x,y,o_cursor.x,o_cursor.y)+random_range(-6,6);
