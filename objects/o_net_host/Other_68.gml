...
if (type == network_type_data) {
	...
	if(packet_type == 0){
		...
		global.invader_ip = _ip;
		global.invader_port = _port;
		global.invader_socket = _id;
		
		scr_host_shit_in_their_mouth();
		//var buffy = buffer_create(8, buffer_grow, 1);
		//buffer_write(buffy, buffer_u8, 0);
		
		// network_send_udp(_id,
	    //    _ip,
	    //    _port,
	    //    buffy,
	    //    buffer_tell(buffy)
