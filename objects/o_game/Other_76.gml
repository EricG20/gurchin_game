    ...
    switch (event_data[? "message"])
    {
		...
		case "play_chill_music":
			if (pylon_wave_number%3 == 0){
				curr_song = choose(intermission_1, intermission_2, intermission_3);
