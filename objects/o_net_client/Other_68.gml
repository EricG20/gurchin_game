...
if (type == network_type_data) {
    ...
    if (packet_type == 2) {
		...
		send_player_appearance(client_socket, my_character_index, my_suit_color, my_hair, o_game.local_player.player_id);
	...
	with (p_proj){
	if (sender.player_id == _player_id && pbullet_num == bullet_number && sender.control_type == cr.NET){
...
//	if (async_load[? "type"] == network_type_udp) {
...
//    // --- Drop old packets (client-side) ---
//    if (seq <= global.last_seq_from_host) exit;
//    global.last_seq_from_host = seq;
...
//            with (o_player) {
//                if (control_type == cr.NET && player_id == sender_id) {
//                    x = px;
//                    y = py;
//                }
//            }
