...
if(!(global.game_speed == 0)){	/// @DnDAction : YoYo Games.Common.Variable
	...
	/// @DnDArgument : "expr_2" "lengthdir_x(70,image_angle)"
	/// @DnDArgument : "expr_3" "-25+lengthdir_y(70,image_angle)"
	/// @DnDArgument : "var" "x"
	/// @DnDArgument : "var_1" "y"
	...
	glorb_x = lengthdir_x(70,image_angle);
	glorb_y = -25+lengthdir_y(70,image_angle);
	...
	if(!(anim == stance.RELOAD)){	/// @DnDAction : YoYo Games.Common.If_Expression
		...
		if(weilder.shooting){	/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Mouse_Down
			...
			/// @DnDArgument : "var" "charge"
			/// @DnDArgument : "op" "4"
			/// @DnDArgument : "value" "20/clamp(global.reload_bonus*weilder.reload_bonus-.5,1,3)"
			if(charge >= 20/clamp(global.reload_bonus*weilder.reload_bonus-.5,1,3)){	/// @DnDAction : YoYo Games.Common.If_Variable
				/// @DnDVersion : 1
				/// @DnDHash : 2A4B330F
				/// @DnDParent : 3A9CC710
				...
				if(laser_out == false){	/// @DnDAction : YoYo Games.Audio.Play_Audio
					...
					audio_play_sound(laser, 0, 0, 1.0, undefined, random_range(.8,1.2));
				
					/// @DnDAction : YoYo Games.Common.Variable
					/// @DnDVersion : 1
					/// @DnDHash : 3A8FB19A
					/// @DnDParent : 2A4B330F
					/// @DnDArgument : "var" "collide_refresh"
					collide_refresh = 0;}
				...
				/// @DnDArgument : "var_4" "collide_refresh"
				kickbackx = 0;
				kickbacky = 0;
				ammo += -1*global.game_speed;
				charge = 125;
				collide_refresh += -1*global.game_speed;
				...
				var l3CE3CBE6_0 = laser_loop;if (!audio_is_playing(l3CE3CBE6_0)){	/// @DnDAction : YoYo Games.Instances.Create_Instance
					...
					/// @DnDArgument : "soundid" "laser_loop"
					/// @DnDArgument : "gain" ".1"
					/// @DnDArgument : "pitch" "1.5 + (ammo/ammo_cap)*1.2"
					/// @DnDSaveInfo : "soundid" "laser_loop"
					audio_play_sound(laser_loop, 0, 0, .1, undefined, 1.5 + (ammo/ammo_cap)*1.2);}
			...
			/// @DnDParent : 3F4C6B2D
				...
				var l2136A587_0 = sfx_gilb_charge;if (!audio_is_playing(l2136A587_0)){	/// @DnDAction : YoYo Games.Audio.Play_Audio
					...
					/// @DnDParent : 2136A587
					/// @DnDArgument : "soundid" "sfx_gilb_charge"
					/// @DnDArgument : "pitch" "2+(charge/120)*.9"
					/// @DnDSaveInfo : "soundid" "sfx_gilb_charge"
					audio_play_sound(sfx_gilb_charge, 0, 0, 1.0, undefined, 2+(charge/120)*.9);}
