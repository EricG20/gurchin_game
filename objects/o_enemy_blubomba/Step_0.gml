...
if(cooldown <= 65)
{
	...
	if(cooldown >= 50)
	{
		...
		/// @DnDHash : 615DC0BE
		/// @DnDParent : 307F0062
		/// @DnDArgument : "var" "cooldown mod 50"
		if(cooldown mod 50 == 0)
		{
			...
			/// @DnDArgument : "objectid" "o_enemy_nade"
			/// @DnDSaveInfo : "objectid" "o_enemy_nade"
			var bul = instance_create_layer(x + facing*27, y + -41, "Instances", o_enemy_nade);
