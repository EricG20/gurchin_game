...
/// @DnDArgument : "arg_4" "target_x=mouse_x"
/// @DnDArgument : "arg_5" "target_y=mouse_y"
function scr_laser(x_offset=0, y_offset=0, h_offset=10, collision_target=o_enemy, target_x=mouse_x, target_y=mouse_y) {	/// @DnDAction : YoYo Games.Common.Execute_Code
	/// @DnDVersion : 1
	/// @DnDHash : 55B0531F
	/// @DnDParent : 467D13D6
